...
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX          8
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommRequests - Pipe: TX_ACK */
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX_ACK          9
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX_ACK_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommIncomingData - Pipe: RX */
#define PIPE_CLOUDCOMM_CLOUDCOMMINCOMINGDATA_RX          10
#define PIPE_CLOUDCOMM_CLOUDCOMMINCOMINGDATA_RX_MAX_SIZE 20
...
/* Service: CloudComm - Characteristic: CloudCommReady - Pipe: RX */
#define PIPE_CLOUDCOMM_CLOUDCOMMREADY_RX          12
#define PIPE_CLOUDCOMM_CLOUDCOMMREADY_RX_MAX_SIZE 1

/* Service: CloudComm - Characteristic: CloudCommReady - Pipe: RX_ACK_AUTO */
#define PIPE_CLOUDCOMM_CLOUDCOMMREADY_RX_ACK_AUTO          13
...
#define GAP_PPCP_MIN_CONN_INT  0x30 /**< Minimum connection interval as a multiple of 1.25 msec , 0xFFFF means no specific value requested */
#define GAP_PPCP_SLAVE_LATENCY 40
...
#define SETUP_MESSAGES_CONTENT {\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x00,0x0d,0x04,0x06,0x00,0x00,0x07,0x00,0x01,\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x20,0x54,0x09,0x08,0x00,0x07,0x2a,0x04,0x01,0x30,0x00,0x80,0x0c,0x28,0x00,0xff,0xff,0x04,\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x21,0x18,0x01,0x00,0x00,0x04,0x04,0x05,0x05,0x00,0x13,0x28,0x03,0x01,0x0e,0x14,0x00,0x03,\
    ...
    {0x00,\
        {\
            ...
            0x00,0x00,0x04,0x04,0x05,0x05,0x00,0x15,0x28,0x03,0x01,0x0e,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x06,0x06,0x21,0x6c,0x00,0x00,0x00,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            ...
            0x08,0x04,0x00,0x14,0x00,0x00,0x2b,0x04,0x01,0x04,0x08,0x04,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x06,0x06,0xf0,0x00,0x03,0x22,0x78,\
        },\
    },\
}
