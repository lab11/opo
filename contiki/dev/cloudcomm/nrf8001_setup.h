...
/* Service: CloudComm - Characteristic: CloudCommData - Pipe: BROADCAST */
#define PIPE_CLOUDCOMM_CLOUDCOMMDATA_BROADCAST          2
#define PIPE_CLOUDCOMM_CLOUDCOMMDATA_BROADCAST_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommData - Pipe: TX */
#define PIPE_CLOUDCOMM_CLOUDCOMMDATA_TX          3
#define PIPE_CLOUDCOMM_CLOUDCOMMDATA_TX_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommData - Pipe: TX_ACK */
#define PIPE_CLOUDCOMM_CLOUDCOMMDATA_TX_ACK          4
#define PIPE_CLOUDCOMM_CLOUDCOMMDATA_TX_ACK_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommMetaData - Pipe: BROADCAST */
#define PIPE_CLOUDCOMM_CLOUDCOMMMETADATA_BROADCAST          5
#define PIPE_CLOUDCOMM_CLOUDCOMMMETADATA_BROADCAST_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommMetaData - Pipe: TX */
#define PIPE_CLOUDCOMM_CLOUDCOMMMETADATA_TX          6
#define PIPE_CLOUDCOMM_CLOUDCOMMMETADATA_TX_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommMetaData - Pipe: TX_ACK */
#define PIPE_CLOUDCOMM_CLOUDCOMMMETADATA_TX_ACK          7
#define PIPE_CLOUDCOMM_CLOUDCOMMMETADATA_TX_ACK_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommRequests - Pipe: BROADCAST */
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_BROADCAST          8
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_BROADCAST_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommRequests - Pipe: TX */
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX          9
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX_MAX_SIZE 20

/* Service: CloudComm - Characteristic: CloudCommRequests - Pipe: TX_ACK */
#define PIPE_CLOUDCOMM_CLOUDCOMMREQUESTS_TX_ACK          10
...
#define PIPE_CLOUDCOMM_CLOUDCOMMINCOMINGDATA_RX_ACK_AUTO          11
...
#define PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_BROADCAST          12
...
#define PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_TX          13
...
#define PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_TX_ACK          14
#define PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_TX_ACK_MAX_SIZE 8

/* Service: Device Information - Characteristic: Model Number String - Pipe: RX_ACK */
#define PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_RX_ACK          15
#define PIPE_DEVICE_INFORMATION_MODEL_NUMBER_STRING_RX_ACK_MAX_SIZE 8
...
#define SETUP_MESSAGES_CONTENT {\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x00,0x0f,0x04,0x06,0x00,0x00,0x07,0x00,0x01,\
            0xc2,0x00,0x20,0x0a,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x1f,0x06,0x20,0x54,0x09,0x08,0x00,0x07,0x2a,0x04,0x01,0xff,0xff,0xff,0xff,0x00,0x00,0xff,0xff,0x04,\
    ...
    {0x00,\
        {\
            ...
            0x00,0x00,0x04,0x04,0x02,0x02,0x00,0x15,0x28,0x00,0x01,0x0a,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x21,0x50,0x18,0x04,0x04,0x05,0x05,0x00,0x16,0x28,0x03,0x01,0x3a,0x17,0x00,0x24,0x2a,0x76,\
            0x14,0x09,0x08,0x00,0x17,0x2a,0x24,0x01,0x6e,0x52,0x46,0x38,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x21,0x6c,0x30,0x30,0x31,0x00,0x06,0x04,0x08,0x07,0x00,0x18,0x29,0x04,0x01,0x19,0x00,0x00,\
            0x00,0x01,0x00,0x00,0x46,0x14,0x03,0x02,0x00,0x19,0x29,0x02,\
        },\
    },\
    {0x00,\
        {\
            0x07,0x06,0x21,0x88,0x01,0x00,0x00,0x00,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x40,0x00,0x2a,0x00,0x01,0x00,0x80,0x04,0x00,0x03,0x00,0x00,0x2b,0x00,0x01,0x00,0x07,0x04,\
            0x00,0x0b,0x00,0x0c,0x2b,0x01,0x01,0x00,0x07,0x04,0x00,0x0e,\
        },\
    },\
    {0x00,\
        {\
            0x1f,0x06,0x40,0x1c,0x00,0x0f,0x2b,0x02,0x01,0x00,0x07,0x04,0x00,0x11,0x00,0x12,0x2b,0x03,0x01,0x04,\
            0x00,0x04,0x00,0x14,0x00,0x00,0x2a,0x24,0x01,0x00,0x17,0x04,\
        },\
    },\
    {0x00,\
        {\
            0x07,0x06,0x40,0x38,0x00,0x17,0x00,0x19,\
        },\
    },\
    {0x00,\
        {\
    ...
    {0x00,\
        {\
            0x06,0x06,0xf0,0x00,0x03,0xd2,0xc0,\
        },\
    },\
}
